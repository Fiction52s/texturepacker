...
rect_xywhf::rect_xywhf(const rect_ltrb& rr) : rect_xywh(rr), flipped(false), tex(NULL) {}
rect_xywhf::rect_xywhf(int x, int y, int width, int height) : rect_xywh(x, y, width, height), flipped(false), tex(NULL) {}
rect_xywhf::rect_xywhf() : flipped(false), tex(NULL) {}
